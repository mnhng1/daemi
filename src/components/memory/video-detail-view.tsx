...
export function VideoDetailView({ memory }: Props) {
  ...
  // Format duration badge, e.g. 1:23 or 0:45
  ...
  const durationLabel = formatDuration(memory.duration_seconds);
