...
export const TicketMemoryCard = React.memo(function TicketMemoryCard({ memory }: Props) {
  ...
  if (mono) {
    return (
      <View style={{ minHeight: 84, flexDirection: "row" }}>
        {/* Left stub-photo panel */}
        <View style={{ width: 98, flexShrink: 0, borderRadius: 8, overflow: "hidden" }}>
          {stubPhotoUrl ? (
            <Image
            ...
            <View style={{ width: 98, height: "100%", backgroundColor: colors.shade }} />
          )}
        </View>
        ...
        >
          ...
          <Text
            ...
            style={{ fontSize: 18, lineHeight: 20, marginTop: 2 }}
            numberOfLines={1}
          >
